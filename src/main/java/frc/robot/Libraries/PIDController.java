...
public class PIDController {
    ...
    /** Will change the values of the instance of PID to the inputs, usefull for changing pid
     * values using smartdashboard.
     * @param P Proportional
     * @param I Integral
     * @param D Derivative
     * @param F constant
     */
    public void editPIDVals(double P, double I, double D, double F){
        kP = P; kI = I; kD = D;
        kF = F;
    }
