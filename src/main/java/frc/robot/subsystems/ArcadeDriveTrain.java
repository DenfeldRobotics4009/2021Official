...
public class ArcadeDriveTrain extends SubsystemBase {
  ...
  public static Double fr, tr, fullr, delta;
   ...
   */
  public ArcadeDriveTrain(Double twistRate, Double forwardRate, Double fullRate, Double Delta) {
    fr = twistRate;
    tr = forwardRate;
    fullr = fullRate;
    delta = Delta;
    ...
    mapLeft1 = new  Speedmapper(PtoEScale, delta, PtoEScale*0.2);
    mapLeft2 = new  Speedmapper(PtoEScale, delta, PtoEScale*0.2);
    mapRight1 = new Speedmapper(PtoEScale, delta, PtoEScale*0.2);
    mapRight2 = new Speedmapper(PtoEScale, delta, PtoEScale*0.2);
  ...
  public static void setLeft1(double speed) {left1.set(speed);}
  public static void setLeft2(double speed) {left2.set(speed);}
  public static void setRight1(double speed) {right1.set(speed);}
  public static void setRight2(double speed) {right2.set(speed);}
}
